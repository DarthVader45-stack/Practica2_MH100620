...
<html lang="es">
    <head>
        <title>OSCAR FRANCISCO MELENDEZ HENRIQUEZ</title>
        ...
        <div class="container-fluid">
                <div class="contenedor">
                    <div class="row align-items-center h-100">
                        <div class="col"></div>
                        <div class="col">
                            <div class="algn-items-center">
                                <p>Oscar Francisco Melendez Henriquez</p>
                                <form name="frm_login" id="frm_login" action="core/process.php">
                                    <table>
                                        <thead>
                                            <tr>
                                               <th class="parrafo_centrado">Inico de Sesion</th>
                                            </tr>
                                            <tr>
                                               <th>&nbsp;</th>
                                            </tr>
